...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        {
            if (e.Position != maskedTextBox2.Mask.Length)
            {
            ...
            {
                toolTip2.ToolTipTitle = "Giriş Reddedildi - Karakter Sayısı Aşıldı";
                toolTip2.Show("Daha fazla giremezsiniz...!", maskedTextBox2, 0, 0, 5000);
